...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 2.3;               //Gain setting for the roll P-controller // 1.3
float pid_i_gain_roll = 0.002;              //Gain setting for the roll I-controller // 0.04
float pid_d_gain_roll = 40.0;              //Gain setting for the roll D-controller // 18.0
int pid_max_roll = 280;                    //Maximum output of the PID-controller (+/-) //400
...
int pid_max_yaw = 300;                     //Maximum output of the PID-controller (+/-) //400
...
void loop(){
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    int minmotors = 1050;
    int maxmotors = 1800;
    if (esc_1 < minmotors) esc_1 = minmotors;                                         //Keep the motors running.
    if (esc_2 < minmotors) esc_2 = minmotors;                                         //Keep the motors running.
    if (esc_3 < minmotors) esc_3 = minmotors;                                         //Keep the motors running.
    if (esc_4 < minmotors) esc_4 = minmotors;                                         //Keep the motors running.

    if(esc_1 > maxmotors)esc_1 = maxmotors;                                           //Limit the esc-1 pulse to 2000us.
    if(esc_2 > maxmotors)esc_2 = maxmotors;                                           //Limit the esc-2 pulse to 2000us.
    if(esc_3 > maxmotors)esc_3 = maxmotors;                                           //Limit the esc-3 pulse to 2000us.
    if(esc_4 > maxmotors)esc_4 = maxmotors;                                           //Limit the esc-4 pulse to 2000us.  
  }
